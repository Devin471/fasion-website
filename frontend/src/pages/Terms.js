  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-content">
        <section><h3>1. Acceptance of Terms</h3><p>By accessing and using MyFashion, you accept and agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.</p></section>
        ...
        <section><h3>7. Limitation of Liability</h3><p>MyFashion acts as a marketplace facilitator. We are not liable for the quality of products sold by third-party sellers.</p></section>
