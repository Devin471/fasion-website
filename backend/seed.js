...
async function seed() {
  ...
  /* ── Products ── */
  const products = [
    { name: 'Classic Fit Oxford Shirt', slug: 'classic-fit-oxford-shirt', description: 'Premium cotton oxford shirt with a timeless fit. Perfect for both casual and semi-formal occasions.', price: 1299, originalPrice: 2499, discount: 48, category: cats[0]._id, seller: seller1._id, images: ['https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=500'], brand: 'Raymond', stock: 50, rating: 4.5, numReviews: 23, sizes: ['S','M','L','XL'], colors: ['White','Blue','Pink'], isFeatured: true },
